...
void main() {
  group(
    'Vault.fromBytes tient son contrat: FormatException, pas TypeError',
    () {
  ...
  test(
    'les entrées relues sont triées, même si le fichier ne l\'était pas',
    () {
  ...
  test(
    'deux entrées de même clef: la plus récente gagne, sans tout perdre',
    () {
      final vault = Vault.fromBytes(
        clair({
          'v': 1,
